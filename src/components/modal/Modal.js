                ...
                <div id="carouselExampleControls" className="carousel slide" data-ride="carousel">
                    <div className="carousel-inner">
                        <div className="zoomer carousel-item active">
                            <img src={
                                project.images && project.images[0] === "ecommerces1" ? images.ecommerces1 :
                                project.images && project.images[0] === "whatsup1" ? images.whatsup1 : 
                                project.images && project.images[0] === "imgShare1" ? images.imgShare1 : 
                                project.images && project.images[0] === "t-rex1" ? images.trex1 : 
                                defaultImg
                            } alt={project.name} />
                        </div>
                            {
